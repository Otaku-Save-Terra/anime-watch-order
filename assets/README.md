...
This directory contains images and other static assets for the AniWatch Order site.

## Note

The original images under assets/images were created and under CC BY 4.0.

As for all images that are not in assets/images were created by original author, artist or studio, and are used under fair use for the purpose of review and commentary. 
